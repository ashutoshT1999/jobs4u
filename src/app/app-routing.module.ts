...
const routes: Routes = [
  ...
  { path: 'candidateEdit', component: EditComponent , canDeactivate:[CandidatesService] },
  { path: 'companyEdit', component: EditCompanyComponent ,canDeactivate:[CompaniesService] },
